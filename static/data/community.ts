...
const header = {
  ...
  image: 'images/optimized/3podman.png',
  imageAlt: 'Three Podman community seals',
  banner: {
...
const communityChat = {
  ...
  links: [
    ...
    },
    {
      ...
      icon: 'simple-icons:liberadotchat',
    },
    {
    ...
    {
      text: 'Podman Discord',
      path: 'https://discord.com/invite/x5GzFF6QH4',
...
const communityMeetings = {
  ...
  subtitle:
    "Many of the maintainers for the Podman project attend both of these meetings, so it's a great chance for community members like you to ask them questions or address concerns directly. If you have a topic that you'd like to propose for either meeting, please send a note to the [mailing list](https://lists.podman.io/).",
  cards: [
    {
...
const communitySocial = {
  title: 'Follow Podman',
  subtitle: 'Get updates, releases, and community news on your favorite platforms.',
};
...
const mailingList = {
  ...
  extraInfo: {
    note: 'If you have a bug that you’d like to report, it’s best to report it here by creating a “New issue” rather than sending an email to the list.',
  },
};
...
export { header, communityChat, communityMeetings, communitySocial, mailingList, submittingIssues };
