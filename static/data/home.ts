...
const featureSection = {
  eyebrow: 'Why Podman?',
  title: 'Built for developers. Designed for freedom.',
  subtitle:
    'Podman is an open source container engine that gives you the speed, security, and flexibility you need.',
};
...
const kubernetesBanner = {
  eyebrow: 'Kubernetes Ready',
  title: 'Run Kubernetes your way.',
  titleHighlight: 'With Podman.',
  description:
  ...
  tools: [
    {
      ...
      href: 'https://marketplace.visualstudio.com/items?itemName=RedHat.vscode-podman',
    },
    {
      title: 'Cirrus CLI',
      ...
      href: 'https://cirrus-ci.org/guide/podman/',
    },
    {
      ...
      href: 'https://github.com/marketplace?query=podman',
    },
    {
      title: 'Kind',
      ...
      href: 'https://kind.sigs.k8s.io/docs/user/local-registry/',
    },
  ],
};
...
export { header, featureSection, featureList, kubernetesBanner, ecosystemSection, compatibleTools, coloringBook };
